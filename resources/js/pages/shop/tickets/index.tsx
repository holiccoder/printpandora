                                ...
                                >
                                    <div className="mb-3 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span
                                                className={`rounded-full px-3 py-1 text-xs font-medium capitalize ${statusColors[ticket.status] ?? 'bg-neutral-100'}`}
                                            >
                                            ...
                                            <span
                                                className={`rounded-full px-3 py-1 text-xs font-medium capitalize ${priorityColors[ticket.priority] ?? 'bg-neutral-100'}`}
                                            >
                                                {ticket.priority}
                                            </span>
                                        </div>
                    ...
                    {tickets.last_page > 1 && (
                        <div className="mt-6 flex items-center justify-center gap-4">
                            ...
                            <span className="text-sm text-[#706f6c]">
                                {c.pagination.page_label_prefix}{' '}
                                {tickets.current_page}{' '}
                                {c.pagination.page_label_separator}{' '}
                                {tickets.last_page}
                            </span>
