    ...
    public static function rules(): array
    {
        return [
            ...
            self::rule(
                ...
                ['sizes' => 'standard', 'paper_finish' => 'matte', 'corners' => 'square', 'special_finish' => 'no_special_finish'],
                'standard-matte-square',
            ),
            self::rule(
                'square-matte-square',
                ['sizes' => 'square', 'paper_finish' => 'matte', 'corners' => 'square', 'special_finish' => 'no_special_finish'],
                'square-matte-square',
            ),
            self::rule(
                'standard-matte-rounded',
                ['sizes' => 'standard', 'paper_finish' => 'matte', 'corners' => 'rounded', 'special_finish' => 'no_special_finish'],
                'standard-matte-rounded',
            ),
            self::rule(
                'square-matte-rounded',
                ['sizes' => 'square', 'paper_finish' => 'matte', 'corners' => 'rounded', 'special_finish' => 'no_special_finish'],
                'square-matte-rounded',
            ),
            self::rule(
                'standard-gloss-square',
                ['sizes' => 'standard', 'paper_finish' => 'gloss', 'corners' => 'square', 'special_finish' => 'no_special_finish'],
                'standard-gloss-square',
            ),
            self::rule(
                'square-gloss-square',
                ['sizes' => 'square', 'paper_finish' => 'gloss', 'corners' => 'square', 'special_finish' => 'no_special_finish'],
                'square-gloss-square',
            ),
            self::rule(
                'standard-gloss-rounded',
                ['sizes' => 'standard', 'paper_finish' => 'gloss', 'corners' => 'rounded', 'special_finish' => 'no_special_finish'],
                'standard-gloss-rounded',
            ),
            self::rule(
                'square-gloss-rounded',
                ['sizes' => 'square', 'paper_finish' => 'gloss', 'corners' => 'rounded', 'special_finish' => 'no_special_finish'],
                'square-gloss-rounded',
            ),
            self::rule(
                'standard-uv-square-single-side',
                ['sizes' => 'standard', 'uv_finish' => 'single_side_uv', 'corners' => 'square', 'special_finish' => 'no_special_finish'],
                'standard-uv-square',
            ),
            self::rule(
                'standard-uv-square-both-sides',
                ['sizes' => 'standard', 'uv_finish' => 'both_sides_uv', 'corners' => 'square', 'special_finish' => 'no_special_finish'],
                'standard-uv-square',
            ),
            self::rule(
                'standard-uv-rounded-single-side',
                ['sizes' => 'standard', 'uv_finish' => 'single_side_uv', 'corners' => 'rounded', 'special_finish' => 'no_special_finish'],
                'standard-uv-rounded',
            ),
            self::rule(
                'standard-uv-rounded-both-sides',
                ['sizes' => 'standard', 'uv_finish' => 'both_sides_uv', 'corners' => 'rounded', 'special_finish' => 'no_special_finish'],
                'standard-uv-rounded',
            ),
            self::rule(
                'square-uv-square-single-side',
                ['sizes' => 'square', 'uv_finish' => 'single_side_uv', 'corners' => 'square', 'special_finish' => 'no_special_finish'],
                'square-uv-square',
            ),
            self::rule(
                'square-uv-square-both-sides',
                ['sizes' => 'square', 'uv_finish' => 'both_sides_uv', 'corners' => 'square', 'special_finish' => 'no_special_finish'],
                'square-uv-square',
            ),
            self::rule(
                'square-uv-rounded-single-side',
                ['sizes' => 'square', 'uv_finish' => 'single_side_uv', 'corners' => 'rounded', 'special_finish' => 'no_special_finish'],
                'square-uv-rounded',
            ),
            self::rule(
                'square-uv-rounded-both-sides',
                ['sizes' => 'square', 'uv_finish' => 'both_sides_uv', 'corners' => 'rounded', 'special_finish' => 'no_special_finish'],
                'square-uv-rounded',
            ),
        ];
    }
